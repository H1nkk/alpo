...
Список представляет собой соединённые узлы с однотипными данными. Каждый узел состоит из элемента и указателя на следующий элемент. Список хранит указатели на свои первый и последний элементы. Итерация по списку происходит посредством итераторов.
